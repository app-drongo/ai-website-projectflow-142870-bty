...
const DEFAULT_HERO = {
  ...
  description:
    'The all-in-one platform that helps teams collaborate, track progress, and deliver projects on time. Built for modern teams who demand efficiency.',
  ...
  showIcon: true,
  iconUrl: '',
  iconAlt: 'Project management platform logo',
} as const;
