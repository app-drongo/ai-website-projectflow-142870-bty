...
const DEFAULT_FEATURES = {
  ...
  feature4Description:
    'Manage multiple projects, teams, and clients from a unified dashboard with customizable views and filters.',
  feature4Badge: 'Dashboard',
  feature5Title: 'Advanced Analytics & Reporting',
  feature5Description:
    'Track project progress, team productivity, and resource utilization with powerful analytics and custom reports.',
  feature5Badge: 'Analytics',
  feature6Title: 'Automated Workflows',
  feature6Description:
    'Create custom automation rules, approval processes, and task dependencies to streamline your project workflows.',
  feature6Badge: 'Automation',
  feature7Title: 'Integrations & API',
  feature7Description:
    'Connect with 100+ tools including Slack, GitHub, Jira, and Google Workspace via our robust API platform.',
  feature7Badge: 'Integration',
  feature8Title: 'Expert Support Team',
  feature8Description:
    'Get help when you need it with 24/7 support, onboarding assistance, and dedicated customer success managers.',
  feature8Badge: 'Support',
  feature9Title: 'Data Security & Backup',
  feature9Description:
    'Your project data is encrypted, automatically backed up, and stored securely with 99.9% uptime guarantee.',
