...
const DEFAULT_FOOTER = {
  logoText: 'TaskFlow',
  companyDescription:
    'Streamline your project management with powerful collaboration tools, intelligent automation, and real-time insights. Trusted by over 10,000 teams worldwide to deliver projects on time and within budget.',
  ...
  linkTutorials: 'Video Tutorials',
  linkTutorialsHref: '/tutorials',
  linkWebinars: 'Live Webinars',
  ...
  linkCompliance: 'SOC 2 Compliance',
